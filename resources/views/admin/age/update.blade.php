					...
					<div class="row">
						...
						<div class="col-3">
							...
							<div class="card">
								...
								<div class="card-body">
									<h1 class="h3 mb-3">Update Age</h1>
									<form action="{{ route('admin.age.update',$age->id) }}" method="post" enctype="multipart/form-data">
										@csrf
										@method('PUT')
										<div class="row">
											<div class="mb-4 col-md-12">
												<label class="form-label">Name</label>
												<input type="text" name="name" class="form-control" placeholder="enter name"  value="{{ old('name',$age->name) }}">
												@error('name')
										...
										<div class="row">
											...
											<div class="mb-4 col-md-12">
												...
												<select class="form-control" name="status" >
													<option value="1" {{$age->status == 1?'selected':''}} >Active</option>
													<option value="0" {{$age->status == 0?'selected':''}}>Inactive</option>
												</select>
